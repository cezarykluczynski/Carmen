...
class UserFollowersFollowingReportToSleepPhasePropagationSchedulerTest extends AbstractTestNGSpringContextTests {
    ...
    @Autowired
    @InjectMocks
    UserFollowersFollowingReportToSleepPhasePropagationScheduler scheduledUserFollowersFollowingReportToSleepPhasePropagationExecutor
